...
ggplot(urban.score, aes(x = urban_score)) + 
  ...
  labs(
    ...
    x = "Score",
    y = "Density",
    caption = "CHARLS 2011 baseline ~ 2018"
  ) + 
  theme_light()
```
...
ggplot(score.df, aes(y=urban_score_com, x=urban_score_ind)) + 
  ...
  labs(
    title = "Internal Validation",
    subtitle = "Correlation between comm. data scores and indiv. scores",
    y = "Community Data Scores",
    x = "Individual Data Scores",
    caption = "CHARLS baseline wave(2011)"
  ) +
  theme_light()
```
```{r}
