...
temp.exp <- temp.exp %>%
  mutate(
    urban_score_exp = case_when(
      urban_score_exp < 1 ~ 0,
      urban_score_exp < 51.9 ~ 0.5,
      urban_score_exp < 103.8 ~ 1,
      urban_score_exp < 155.7 ~ 1.5,
      urban_score_exp < 207.6 ~ 2,
      urban_score_exp < 259.5 ~ 2.5,
      urban_score_exp < 311.4 ~ 3,
      urban_score_exp < 363.3 ~ 3.5,
      urban_score_exp < 415.2 ~ 4,
      urban_score_exp < 467.1 ~ 4.5,
      urban_score_exp < 3327.83 ~ 5,
      urban_score_exp < 6188.56 ~ 5.5,
      urban_score_exp < 9049.30 ~ 6,
      urban_score_exp < 11910.03 ~ 6.5,
      urban_score_exp < 14770.77 ~ 7,
      urban_score_exp < 17631.5 ~ 7.5,
      urban_score_exp < 20492.24 ~ 8,
      urban_score_exp < 23352.97 ~ 8.5,
      urban_score_exp < 26213.71 ~ 9,
      urban_score_exp < 29074.44 ~ 9.5,
      urban_score_exp >= 29074.44 ~ 10
    )
  )
```

```{r}
ggplot(temp.exp, aes(x=urban_score_exp)) + 
